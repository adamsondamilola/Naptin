...
/*!40000 ALTER TABLE `geo_political_zones` DISABLE KEYS */;
INSERT INTO `geo_political_zones` (`id`, `name`) VALUES
    (1, 'North Central'),
    (2, 'North East'),
    (3, 'North West'),
    (4, 'South East'),
    (5, 'South South'),
    (6, 'South West');
/*!40000 ALTER TABLE `geo_political_zones` ENABLE KEYS */;
...
INSERT INTO `local_areas` (`id`, `state_id`, `name`) VALUES
   (1, 1, 'Aba North'),
   (2, 1, 'Aba South'),
   (3, 1, 'Arochukwu'),
   (4, 1, 'Bende'),
...
CREATE TABLE IF NOT EXISTS `states` (
  ...
  `geo_political_zone_id` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=latin1;


/*!40000 ALTER TABLE `states` DISABLE KEYS */;
INSERT INTO `states` (`id`, `name`, `country_id`, `geo_political_zone_id`) VALUES
      (1, 'Abia', 1, 4),
      (2, 'Adamawa', 1, 2),
      (3, 'Akwa Ibom', 1, 5),
      (4, 'Anambra', 1, 4),
